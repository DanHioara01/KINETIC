...
object LanguageManager {
    ...
    private val strings = mapOf(
        "ro" to Strings(mapOf(
            ...
            "gpsCardioMap" to "Cardio GPS", "startTracking" to "Pornește urmărirea", "stopTracking" to "Oprește urmărirea",
            "distance" to "Distanță", "pace" to "Ritm", "speed" to "Viteză", "duration" to "Durată",
            "calories" to "Calorii", "savedRoutes" to "Rute salvate", "noSavedRoutes" to "Nicio rută salvată încă",
        ...
        "ru" to Strings(mapOf(
            ...
            "gpsCardioMap" to "Кардио GPS", "startTracking" to "Начать отслеживание", "stopTracking" to "Остановить отслеживание",
            "distance" to "Дистанция", "pace" to "Темп", "speed" to "Скорость", "duration" to "Длительность",
            "calories" to "Калории", "savedRoutes" to "Сохранённые маршруты", "noSavedRoutes" to "Нет сохранённых маршрутов",
        ...
        "uk" to Strings(mapOf(
            ...
            "gpsCardioMap" to "Кардіо GPS", "startTracking" to "Почати відстеження", "stopTracking" to "Зупинити відстеження",
            "distance" to "Дистанція", "pace" to "Темп", "speed" to "Швидкість", "duration" to "Тривалість",
            "calories" to "Калорії", "savedRoutes" to "Збережені маршрути", "noSavedRoutes" to "Немає збережених маршрутів",
        ...
        "fr" to Strings(mapOf(
            ...
            "nutritionLabel" to "Nutrition", "motivationLabel" to "Motivation",
            "gpsCardioMap" to "Carte Cardio GPS", "startTracking" to "Commencer le suivi", "stopTracking" to "Arrêter le suivi",
            "distance" to "Distance", "pace" to "Rythme", "speed" to "Vitesse", "duration" to "Durée",
            "calories" to "Calories", "savedRoutes" to "Itinéraires sauvegardés", "noSavedRoutes" to "Aucun itinéraire sauvegardé",
        ...
        "de" to Strings(mapOf(
            ...
            "gpsCardioMap" to "GPS Kardio-Karte", "startTracking" to "Tracking starten", "stopTracking" to "Tracking stoppen",
            "distance" to "Distanz", "pace" to "Tempo", "speed" to "Geschwindigkeit", "duration" to "Dauer",
            "calories" to "Kalorien", "savedRoutes" to "Gespeicherte Routen", "noSavedRoutes" to "Keine gespeicherten Routen",
        ...
        "es" to Strings(mapOf(
            ...
            "gpsCardioMap" to "Mapa Cardio GPS", "startTracking" to "Iniciar seguimiento", "stopTracking" to "Detener seguimiento",
            "distance" to "Distancia", "pace" to "Ritmo", "speed" to "Velocidad", "duration" to "Duración",
            "calories" to "Calorías", "savedRoutes" to "Rutas guardadas", "noSavedRoutes" to "No hay rutas guardadas",
        ...
        "it" to Strings(mapOf(
            ...
            "gpsCardioMap" to "Mappa Cardio GPS", "startTracking" to "Inizia tracciamento", "stopTracking" to "Ferma tracciamento",
            "distance" to "Distanza", "pace" to "Ritmo", "speed" to "Velocità", "duration" to "Durata",
            "calories" to "Calorie", "savedRoutes" to "Percorsi salvati", "noSavedRoutes" to "Nessun percorso salvato",
        ...
        "tr" to Strings(mapOf(
            ...
            "gpsCardioMap" to "GPS Kardiyo Haritası", "startTracking" to "Takibi başlat", "stopTracking" to "Takibi durdur",
            "distance" to "Mesafe", "pace" to "Tempo", "speed" to "Hız", "duration" to "Süre",
            "calories" to "Kaloriler", "savedRoutes" to "Kayıtlı rotalar", "noSavedRoutes" to "Henüz kayıtlı rota yok",
        ...
        "pt" to Strings(mapOf(
            ...
            "gpsCardioMap" to "Mapa Cardio GPS", "startTracking" to "Iniciar rastreamento", "stopTracking" to "Parar rastreamento",
            "distance" to "Distância", "pace" to "Ritmo", "speed" to "Velocidade", "duration" to "Duração",
            "calories" to "Calorias", "savedRoutes" to "Rotas salvas", "noSavedRoutes" to "Nenhuma rota salva",
        ...
        "pl" to Strings(mapOf(
            ...
            "gpsCardioMap" to "Mapa Kardio GPS", "startTracking" to "Rozpocznij śledzenie", "stopTracking" to "Zatrzymaj śledzenie",
            "distance" to "Dystans", "pace" to "Tempo", "speed" to "Prędkość", "duration" to "Czas trwania",
            "calories" to "Kalorie", "savedRoutes" to "Zapisane trasy", "noSavedRoutes" to "Brak zapisanych tras",
