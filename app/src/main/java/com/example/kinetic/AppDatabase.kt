...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_28_29 = object : Migration(28, 29) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL(
                    "CREATE TABLE IF NOT EXISTS messages (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title TEXT NOT NULL, body TEXT NOT NULL, type TEXT NOT NULL, timestamp INTEGER NOT NULL, isRead INTEGER NOT NULL DEFAULT 0)"
                )
            }
        }
        ...
        private val MIGRATION_29_30 = object : Migration(29, 30) {
            ...
            CoroutineScope(Dispatchers.IO).launch {
                try {
                    ...
                    dao.insert(MessageEntity(title = "Welcome to KINETIC!", body = "Your fitness journey starts here. Track workouts, set goals, and crush your PRs.", type = "SUCCESS", timestamp = now - 3600000))
                    dao.insert(MessageEntity(title = "Stay hydrated", body = "Drinking water during workouts improves performance by up to 20%. Set a reminder!", type = "REMINDER", timestamp = now - 7200000))
                    dao.insert(MessageEntity(title = "New: Messages inbox", body = "This is your messages inbox. You will receive workout reminders, sync notifications, and achievement alerts here.", type = "INFO", timestamp = now - 10800000))
                } catch (_: Exception) {}
            }
        }
