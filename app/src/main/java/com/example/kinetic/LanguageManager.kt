...
object LanguageManager {
    ...
    class Strings(m: Map<String, String>) {
        ...
        val workoutPlans: String = m["workoutPlans"] ?: "Workout Plans"
        val createPlan: String = m["createPlan"] ?: "Create Plan"
        val planName: String = m["planName"] ?: "Plan Name"
        val planDescription: String = m["planDescription"] ?: "Description"
        val daysPerWeek: String = m["daysPerWeek"] ?: "Days / week"
        val addExercise: String = m["addExercise"] ?: "Add Exercise"
        val sharePlan: String = m["sharePlan"] ?: "Share Plan"
        val sharedWithYou: String = m["sharedWithYou"] ?: "Shared with you"
        val planShared: String = m["planShared"] ?: "wants to share a workout plan with you"
        val importPlan: String = m["importPlan"] ?: "Import Plan"
        val noPlansYet: String = m["noPlansYet"] ?: "No plans yet"
        val createFirstPlan: String = m["createFirstPlan"] ?: "Create your first workout plan"
        val messageDeleted: String = m["messageDeleted"] ?: ""
        val markAllRead: String = m["markAllRead"] ?: "Mark all read"
        val clearAll: String = m["clearAll"] ?: "Clear all"
        val notificationDeleted: String = m["notificationDeleted"] ?: "Notification deleted"
